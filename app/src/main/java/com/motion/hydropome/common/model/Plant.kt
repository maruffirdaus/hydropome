...
data class Plant(
    ...
    companion object {
        ...
        fun fromFirestore(data: Map<String, Any>): Plant = Plant(
            ...
            toolsAndMaterials = (data["toolsAndMaterials"] as List<Map<String, String>>).let {
                it.map { toolMaterial ->
                    ToolMaterial(
            ...
            tasksByDay = (data["tasksByDay"] as List<Map<String, Any>>).let {
                it.map { dailyTasks ->
                    DailyTasks(
                        tasks = dailyTasks["tasks"] as List<String>,
